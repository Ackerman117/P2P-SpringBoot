 ...
 */
@Component
@Service(interfaceClass = KuaiQianService.class, version = "1.0.0", timeout = 1500)
public class KuaiQianServiceImpl implements KuaiQianService {
    ...
    @Override
    public Map<String, String> makeKuaiQianRequestParam(String orderNo, String yuan, String name, String phone, String remoteAddr) {
    ...
    public String appendParam(String returns, String paramId, String paramValue, Map<String, String> res) {
        if (returns != "") {
